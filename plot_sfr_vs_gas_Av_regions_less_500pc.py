...
if __name__ == "__main__":
    ...
    index_less500pc_class_I = distance_class_I <= 500
    ...
    index_less500pc_class_F = distance_class_F <= 500
    #--------------------------------------------
    # Plot the figure
    ...
    # Class_I 
    ax.errorbar(
        x = gas_sigma_class_I[(~index_U_class_I) & (index_less500pc_class_I)],
        xerr = e_gas_sigma_class_I[(~index_U_class_I) & (index_less500pc_class_I)],
        y = sfr_sigma_class_I[(~index_U_class_I) & (index_less500pc_class_I)],
        yerr = e_sfr_sigma_class_I[(~index_U_class_I) & (index_less500pc_class_I)],
        label= 'Class I YSO',
        color = 'b',
        fmt = 'o'
    )
    ...
    # Class_F
    ax.errorbar(
        x = gas_sigma_class_F[(~index_U_class_F) & (index_less500pc_class_F)],
        xerr = e_gas_sigma_class_F[(~index_U_class_F) & index_less500pc_class_F],
        y = sfr_sigma_class_F[(~index_U_class_F) & (index_less500pc_class_F)],
        yerr = e_sfr_sigma_class_F[(~index_U_class_F) & (index_less500pc_class_F)],
    ...
    ax.legend()
    fig.savefig("chiu20_sfr_vs_gas_Av_regions_less500pc.png")
    #-----------------------------------
    # Measure time
