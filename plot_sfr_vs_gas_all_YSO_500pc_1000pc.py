...
if __name__ == "__main__":
    ...
    index_500pc_1000pc_class_I = np.logical_and(distance_class_I > 500, distance_class_I <= 1000)
    ...
    index_500pc_1000pc_class_F = np.logical_and(distance_class_F > 500, distance_class_F <= 1000)
    #--------------------------------------------
    # Plot the figure
    fig, ax = plt.subplots(figsize = (8,8))
    #----------
    # Class_I 
    if len(gas_sigma_class_I[(~index_U_class_I) & (index_500pc_1000pc_class_I)]) != 0:
        ax.errorbar(
            x = gas_sigma_class_I[(~index_U_class_I) & (index_500pc_1000pc_class_I)],
            xerr = e_gas_sigma_class_I[(~index_U_class_I) & (index_500pc_1000pc_class_I)],
            y = sfr_sigma_class_I[(~index_U_class_I) & (index_500pc_1000pc_class_I)],
            yerr = e_sfr_sigma_class_I[(~index_U_class_I) & (index_500pc_1000pc_class_I)],
            label= 'Class I YSO',
            color = 'b',
            fmt = 'o'
        )
    ...
    #----------
    # Class_F
    if len(gas_sigma_class_F[(~index_U_class_F) & (index_500pc_1000pc_class_F)]) != 0:
        ax.errorbar(
            x = gas_sigma_class_F[(~index_U_class_F) & (index_500pc_1000pc_class_F)],
            xerr = e_gas_sigma_class_F[(~index_U_class_F) & index_500pc_1000pc_class_F],
            y = sfr_sigma_class_F[(~index_U_class_F) & (index_500pc_1000pc_class_F)],
            yerr = e_sfr_sigma_class_F[(~index_U_class_F) & (index_500pc_1000pc_class_F)],
    ...
    ax.legend()
    fig.savefig("chiu20_sfr_vs_gas_Av_regions_500pc_1000pc.png")
    #-----------------------------------
    # Measure time
